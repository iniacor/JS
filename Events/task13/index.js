...
// 5 получаем через event-target значение id (дата атрибута) целевого чекбокса. У данного чекбокса получаем значение атрибута done - Если значение true - меняем на false, если значение false - на true
